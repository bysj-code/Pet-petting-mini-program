<template>
	<div class="diy_details page_rescue_base" id="rescue_base_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_rescue_base'>
							<div_rescue_base :obj="obj"></div_rescue_base>
...
<script>
	import div_rescue_base from "@/components/diy/div_rescue_base.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.rescue_base_id;
				}
			},
			/**
			 * 分页器

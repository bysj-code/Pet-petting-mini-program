<template>
	<div class="diy_details_box diy_div_rescue_base">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/donation_information/edit','add')" @click="to_form('/donation_information/edit')" > 捐助 </button>
										</div>
						<!-- 富文本 -->

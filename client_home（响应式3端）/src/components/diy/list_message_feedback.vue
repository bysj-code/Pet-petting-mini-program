<template>
	<div class="diy_home diy_list diy_message_feedback" id="diy_message_feedback_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/message_feedback/details?message_feedback_id=' + o['message_feedback_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/message_feedback/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/message_feedback/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','message_user')">
						留言用户
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field diy_uid" v-if="$check_field('get','message_user')">
						<span>
							{{ get_user_name('message_user',o['message_user']) }}
						</span>
					</td>
		...
		methods: {
			get_user_name(name,id){
				var obj = null;
					...
					obj = this.list_user_message_user.getObj({"user_id":id});
				}
									var ret = "";
				if(obj){

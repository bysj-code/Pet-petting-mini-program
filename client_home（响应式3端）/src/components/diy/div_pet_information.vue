			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/adoption_information/edit','add')" @click="to_form('/adoption_information/edit')" > 领养 </button>
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var pet_information_id = this.obj.pet_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "pet_information",
          source_field: "pet_information_id",
          source_id: pet_information_id
        }, (res) => {

<template>
	<div class="diy_home diy_list diy_pet_daily" id="diy_pet_daily_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/pet_daily/details?pet_daily_id=' + o['pet_daily_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/pet_daily/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/pet_daily/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						用户姓名
							...
							<th class="diy_title" v-if="$check_field('get','report_date')">
						报告日期
					</th>
							<th class="diy_title" v-if="$check_field('get','pet_daily')">
						宠物日常
					</th>
							</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','report_date')">
						<span>
							{{ $toTime(o["report_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','pet_daily')">
						<span>
							{{ o["pet_daily"] }}
						</span>
					</td>

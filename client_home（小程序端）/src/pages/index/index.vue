<template>
  <view id="home" class="home--new">
    ...
    <Card
      class="list_diy"
      title="宠物信息推荐"
      url="/pages/pet_information/list"
      :list="list_article"
      v-if="$check_action('/pet_information/list', 'get')"
    >
	  <list_pet_information :list="list_pet_information"></list_pet_information>
    ...
    <Card
      class="list_diy"
      title="救助基地推荐"
      url="/pages/rescue_base/list"
      :list="list_article"
      v-if="$check_action('/rescue_base/list', 'get')"
    >
	  <list_rescue_base :list="list_rescue_base"></list_rescue_base>
		...
		*/
		get_pet_information() {
			...
			this.$get(url, {
					...
					console.log("宠物信息" ,json.result.list);
					this.list_pet_information = json.result.list;
											this.list_pet_information.map((o)=>{
							o["praise_len"];
						});
						this.get_praise(this.list_pet_information ,"pet_information" ,"22186");
									}
			});
		},
    				/**
		...
		*/
		get_rescue_base() {
			...
			this.$get(url, {
					...
					if (json.result && json.result.list) {
					console.log("救助基地" ,json.result.list);

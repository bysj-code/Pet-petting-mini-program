<template>
  <view class="page_pet_information diy_table diy_table_tml" id="pet_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="宠物类型" name="type_of_pet">
                  <uni-data-select placeholder="请选择"
            v-model="query['type_of_pet']"
            :localdata="list_type_of_pet"
        ></uni-data-select>
                         </uni-forms-item>
                            <uni-forms-item label="领养状态" name="adoption_status">
                 <uni-data-select placeholder="请选择"
                        v-model="query['adoption_status']"
                        :localdata="list_adoption_status"
       ></uni-data-select>
                          </uni-forms-item>
                      <uni-forms-item label="是否疾病" name="disease_or_not">
                 <uni-data-select placeholder="请选择"
                        v-model="query['disease_or_not']"
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/pet_information/view?" v-show="user_group == '管理员' || $check_action('/pet_information/table','add') || $check_action('/pet_information/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','pet_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','type_of_pet')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宠物类型</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','pet_color')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宠物颜色</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','pet_sex')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宠物性别</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','pet_age')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宠物年龄</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','pet_pictures')">
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>宠物图片</span>
							</view>
															<view class="diy_field diy_img">
									<img :src="$fullUrl(o['pet_pictures'])" width="100%" height="100" />
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','adoption_status')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>领养状态</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','adoption_address')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>领养地址</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','disease_or_not')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>是否疾病</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','introduction_to_pets')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宠物简介</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/pet_information/table','del') || $check_action('/pet_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/pet_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/pet_information/table','set') || $check_action('/pet_information/view','set') || $check_action('/pet_information/view','get')" class="btn btn-primary">详情</navigator>
																							<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/adoption_information/view','add')" @click="to_form('/pages/adoption_information/view',o)">
									<span>领养</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                            // 宠物类型列表
                list_type_of_pet: [{value:"",text:"全部"}],
                                    // 宠物性别列表
                list_pet_sex: [{value:"",text:"全部"}],
                                            // 领养状态列表
                list_adoption_status: [{value:"",text:"全部"}],
                                    // 是否疾病列表
                list_disease_or_not: [{value:"",text:"全部"}],
                			}
		},
		methods: {
          search() {

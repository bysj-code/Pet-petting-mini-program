<template>
	<view class="page_pet_information diy_detail diy_detail--new" id="pet_information_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					<view v-if="$check_field('get','pet_name')" class="col-12 col-6">
						<view class="view">
					...
					<view v-if="$check_field('get','type_of_pet')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物类型</span>
							</view>
					...
					<view v-if="$check_field('get','pet_color')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物颜色</span>
							</view>
					...
					<view v-if="$check_field('get','pet_sex')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物性别</span>
							</view>
					...
					<view v-if="$check_field('get','pet_age')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物年龄</span>
							</view>
					...
					<view v-if="$check_field('get','pet_pictures')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物图片</span>
							</view>
								<view class="diy_field diy_img">
								<img :src="$fullUrl(obj['pet_pictures'])" />
							</view>
							</view>
					</view>
					<view v-if="$check_field('get','adoption_status')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>领养状态</span>
							</view>
					...
					<view v-if="$check_field('get','adoption_address')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>领养地址</span>
							</view>
					...
					<view v-if="$check_field('get','disease_or_not')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>是否疾病</span>
							</view>
					...
					<view v-if="$check_field('get','introduction_to_pets')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>宠物简介</span>
							</view>
		...
		<view class="warp">
			<view class="container-fluid container-fluid-comment--new">
				<view class="row">
					<view class="col">
									<button type="button" class="btn btn-primary" v-if="$check_action('/adoption_information/edit','add')" @click="to_form('/pages/adoption_information/edit')">
							<span>领养</span>
						</button>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=pet_information&source_field=pet_information_id&source_id=' + obj['pet_information_id']">
							评论
						</navigator>
			...
			change_collect() {
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
								query.title = this.obj.pet_name
																																		query.img = this.obj.pet_pictures

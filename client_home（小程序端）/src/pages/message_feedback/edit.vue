	...
	<view class="diy_edit page_message_feedback" id="message_feedback_edit">
		<view class='warp'>
			<view class='container'>
				<view class='row'>
						<view v-if="$check_field('set','message_user') || $check_field('add','message_user') || $check_field('get','message_user')" class="col-12 col-md-6 row-item">
						...
						<view class="diy_field diy_down diy_text_row diy_select_flex">
							<uni-data-select
									...
									v-if="(form['message_user'] && $check_field('set','message_user')) || (!form['message_user'] && $check_field('add','message_user'))"
							></uni-data-select>
							<text v-else-if="$check_field('get','message_user')">{{ form['message_user'] }}</text>
						</view>
					</view>
						...
						<view class="diy_title diy_text_row">
							...
							<view v-if="$check_field('set','message_title') || $check_field('add','message_title') || $check_field('get','message_title')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								留言标题:
							</text>
							...
							<text v-else-if="$check_field('get','message_title')">{{ form['message_title'] }}</text>
						</view>
										</view>
							<view v-if="$check_field('set','message_date') || $check_field('add','message_date') || $check_field('get','message_date')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								留言日期:
							</text>
						...
						<view class="diy_field diy_date">
							<uni-datetime-picker :disabled="disabledObj['message_date_isDisabled']" type="date" id="form_message_date" v-model="form['message_date']" placeholder="请输入留言日期" v-if="(form['message_date'] && $check_field('set','message_date')) || (!form['message_date'] && $check_field('add','message_date'))" />
							<text v-else-if="$check_field('get','message_date')">{{ form['message_date'] }}</text>
						</view>
							</view>

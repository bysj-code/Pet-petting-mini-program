<template>
  <view class="page_donation_information diy_table diy_table_tml" id="donation_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="救助标题" name="rescue_title">
                      <uni-easyinput type="text" v-model="query.rescue_title" placeholder="救助标题" />
                    </uni-forms-item>
                            </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/donation_information/view?" v-show="user_group == '管理员' || $check_action('/donation_information/table','add') || $check_action('/donation_information/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','rescue_title')" class="col">
						<view class="view">
                            ...
                            <span>救助标题</span>
								...
								<text>
									{{ o["rescue_title"] }}
													...
													<view v-if="0 && $check_field('get','title_no')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>标题编号</span>
                          </view>
								...
								<text>
									{{ o["title_no"] }}
													...
													<view v-if="0 && $check_field('get','application_user')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>申请用户</span>
                          </view>
								...
								<text>
									{{ get_user_application_user(o['application_user']) }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','assistance_needs')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>救助需求</span>
                          </view>
								...
								<text>
									{{ o["assistance_needs"] }}
													...
													<view v-if="0 && $check_field('get','donor_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>捐助用户</span>
                          </view>
											<view class="diy_field diy_uid text">
								<text>
									{{ get_user_donor_users(o['donor_users']) }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','donations')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>捐助物品</span>
                          </view>
								...
								<text>
									{{ o["donations"] }}
													...
													<view v-if="0 && $check_field('get','donation_amount')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>捐助金额</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/donation_information/table','del') || $check_action('/donation_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/donation_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/donation_information/table','set') || $check_action('/donation_information/view','set') || $check_action('/donation_information/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>

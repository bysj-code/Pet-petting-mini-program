<template>
  <view class="page_type_of_pet diy_table diy_table_tml" id="type_of_pet_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="宠物类型" name="type_of_pet">
                      <uni-easyinput type="text" v-model="query.type_of_pet" placeholder="宠物类型" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/type_of_pet/view?" v-show="user_group == '管理员' || $check_action('/type_of_pet/table','add') || $check_action('/type_of_pet/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/type_of_pet/table','del') || $check_action('/type_of_pet/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/type_of_pet/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/type_of_pet/table','set') || $check_action('/type_of_pet/view','set') || $check_action('/type_of_pet/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
